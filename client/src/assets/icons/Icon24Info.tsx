...
interface Icon24InfoProps {

}

const Icon24Info: FC<Icon24InfoProps> = ({}) => {
    return (
        <svg className="Icon Icon24Info" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
